{
  ...
  '#':: d.pkg(name='volumeAttachmentSource', url='', help='"VolumeAttachmentSource represents a volume that should be attached. Right now only PersistentVolumes can be attached via external attacher, in the future we may allow also inline volumes in pods. Exactly one member can be set."'),
  ...
  inlineVolumeSpec: {
    ...
    cephfs: {
      ...
      mapMonitors(f): { inlineVolumeSpec+: { cephfs+: { monitors: std.map(f, super.monitors) } } },
    ...
    csi: {
      ...
      nodeExpandSecretRef: {
        '#withName':: d.fn(help='"name is unique within a namespace to reference a secret resource."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { inlineVolumeSpec+: { csi+: { nodeExpandSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"namespace defines the space within which the secret name must be unique."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { inlineVolumeSpec+: { csi+: { nodeExpandSecretRef+: { namespace: namespace } } } },
      },
    ...
    fc: {
      ...
      mapTargetWWNs(f): { inlineVolumeSpec+: { fc+: { targetWWNs: std.map(f, super.targetWWNs) } } },
      ...
      mapWwids(f): { inlineVolumeSpec+: { fc+: { wwids: std.map(f, super.wwids) } } },
    ...
    iscsi: {
      ...
      mapPortals(f): { inlineVolumeSpec+: { iscsi+: { portals: std.map(f, super.portals) } } },
      '#secretRef':: d.obj(help='"SecretReference represents a Secret Reference. It has enough information to retrieve secret in any namespace"'),
      secretRef: {
        '#withName':: d.fn(help='"name is unique within a namespace to reference a secret resource."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    mapAccessModes(f): { inlineVolumeSpec+: { accessModes: std.map(f, super.accessModes) } },
    ...
    mapMountOptions(f): { inlineVolumeSpec+: { mountOptions: std.map(f, super.mountOptions) } },
    ...
    nodeAffinity: {
      ...
      required: {
        ...
        mapNodeSelectorTerms(f): { inlineVolumeSpec+: { nodeAffinity+: { required+: { nodeSelectorTerms: std.map(f, super.nodeSelectorTerms) } } } },
    ...
    rbd: {
      ...
      mapMonitors(f): { inlineVolumeSpec+: { rbd+: { monitors: std.map(f, super.monitors) } } },
      '#secretRef':: d.obj(help='"SecretReference represents a Secret Reference. It has enough information to retrieve secret in any namespace"'),
      secretRef: {
        '#withName':: d.fn(help='"name is unique within a namespace to reference a secret resource."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    withVolumeAttributesClassName(volumeAttributesClassName): { inlineVolumeSpec+: { volumeAttributesClassName: volumeAttributesClassName } },
