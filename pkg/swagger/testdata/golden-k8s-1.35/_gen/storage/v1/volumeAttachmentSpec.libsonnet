  ...
  source: {
    ...
    inlineVolumeSpec: {
      ...
      cephfs: {
        ...
        mapMonitors(f): { source+: { inlineVolumeSpec+: { cephfs+: { monitors: std.map(f, super.monitors) } } } },
      ...
      csi: {
        ...
        nodeExpandSecretRef: {
          '#withName':: d.fn(help='"name is unique within a namespace to reference a secret resource."', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { source+: { inlineVolumeSpec+: { csi+: { nodeExpandSecretRef+: { name: name } } } } },
          '#withNamespace':: d.fn(help='"namespace defines the space within which the secret name must be unique."', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { source+: { inlineVolumeSpec+: { csi+: { nodeExpandSecretRef+: { namespace: namespace } } } } },
        },
      ...
      fc: {
        ...
        mapTargetWWNs(f): { source+: { inlineVolumeSpec+: { fc+: { targetWWNs: std.map(f, super.targetWWNs) } } } },
        ...
        mapWwids(f): { source+: { inlineVolumeSpec+: { fc+: { wwids: std.map(f, super.wwids) } } } },
      ...
      iscsi: {
        ...
        mapPortals(f): { source+: { inlineVolumeSpec+: { iscsi+: { portals: std.map(f, super.portals) } } } },
        '#secretRef':: d.obj(help='"SecretReference represents a Secret Reference. It has enough information to retrieve secret in any namespace"'),
        secretRef: {
          '#withName':: d.fn(help='"name is unique within a namespace to reference a secret resource."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      mapAccessModes(f): { source+: { inlineVolumeSpec+: { accessModes: std.map(f, super.accessModes) } } },
      ...
      mapMountOptions(f): { source+: { inlineVolumeSpec+: { mountOptions: std.map(f, super.mountOptions) } } },
      ...
      nodeAffinity: {
        ...
        required: {
          ...
          mapNodeSelectorTerms(f): { source+: { inlineVolumeSpec+: { nodeAffinity+: { required+: { nodeSelectorTerms: std.map(f, super.nodeSelectorTerms) } } } } },
      ...
      rbd: {
        ...
        mapMonitors(f): { source+: { inlineVolumeSpec+: { rbd+: { monitors: std.map(f, super.monitors) } } } },
        '#secretRef':: d.obj(help='"SecretReference represents a Secret Reference. It has enough information to retrieve secret in any namespace"'),
        secretRef: {
          '#withName':: d.fn(help='"name is unique within a namespace to reference a secret resource."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      withVolumeAttributesClassName(volumeAttributesClassName): { source+: { inlineVolumeSpec+: { volumeAttributesClassName: volumeAttributesClassName } } },
