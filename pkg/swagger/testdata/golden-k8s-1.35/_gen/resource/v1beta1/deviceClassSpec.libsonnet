{
  ...
  '#mapConfig':: d.fn(help='"Config defines configuration parameters that apply to each device that is claimed via this class. Some classses may potentially be satisfied by multiple drivers, so each instance of a vendor configuration applies to exactly one driver.\\n\\nThey are passed to the driver, but are not considered while allocating the claim."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapConfig(f): { config: std.map(f, super.config) },
  '#mapSelectors':: d.fn(help='"Each selector must be satisfied by a device which is claimed via this class."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapSelectors(f): { selectors: std.map(f, super.selectors) },
