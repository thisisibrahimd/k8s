{
  ...
  '#mapIps':: d.fn(help="\"IPs lists the network addresses assigned to the device's network interface. This can include both IPv4 and IPv6 addresses. The IPs are in the CIDR notation, which includes both the address and the associated subnet mask. e.g.: \\\"192.0.2.5/24\\\" for IPv4 and \\\"2001:db8::5/64\\\" for IPv6.\\n\\nMust not contain more than 16 entries.\"\n\n**Note:** This function maps each element using the provided function", args=[d.arg(name='f', type=d.T['function'])]),
  mapIps(f): { ips: std.map(f, super.ips) },
