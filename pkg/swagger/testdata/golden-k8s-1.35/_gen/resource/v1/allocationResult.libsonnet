{
  ...
  devices: {
    '#mapConfig':: d.fn(help='"This field is a combination of all the claim and class configuration parameters. Drivers can distinguish between those based on a flag.\\n\\nThis includes configuration parameters for drivers which have no allocated devices in the result because it is up to the drivers which configuration parameters they support. They can silently ignore unknown configuration parameters."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
    mapConfig(f): { devices+: { config: std.map(f, super.config) } },
    '#mapResults':: d.fn(help='"Results lists all allocated devices."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
    mapResults(f): { devices+: { results: std.map(f, super.results) } },
  ...
  '#withAllocationTimestamp':: d.fn(help='"Time is a wrapper around time.Time which supports correct marshaling to YAML and JSON.  Wrappers are provided for many of the factory methods that the time package offers."', args=[d.arg(name='allocationTimestamp', type=d.T.string)]),
  withAllocationTimestamp(allocationTimestamp): { allocationTimestamp: allocationTimestamp },
  '#mixin': 'ignore',
  mixin: self,
}
