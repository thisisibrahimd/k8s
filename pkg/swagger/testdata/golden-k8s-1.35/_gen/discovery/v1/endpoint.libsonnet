{
  ...
  hints: {
    ...
    mapForNodes(f): { hints+: { forNodes: std.map(f, super.forNodes) } },
    ...
    mapForNodesByName(name, transformFunc): { hints+: { forNodes: [if c.name == name then transformFunc(c) else c for c in super.forNodes] } },
    ...
    mapForZones(f): { hints+: { forZones: std.map(f, super.forZones) } },
    ...
    mapForZonesByName(name, transformFunc): { hints+: { forZones: [if c.name == name then transformFunc(c) else c for c in super.forZones] } },
    ...
    withForNodes(forNodes): { hints+: { forNodes: if std.isArray(v=forNodes) then forNodes else [forNodes] } },
    ...
    withForNodesMixin(forNodes): { hints+: { forNodes+: if std.isArray(v=forNodes) then forNodes else [forNodes] } },
  ...
  '#mapAddresses':: d.fn(help='"addresses of this endpoint. For EndpointSlices of addressType \\"IPv4\\" or \\"IPv6\\", the values are IP addresses in canonical form. The syntax and semantics of other addressType values are not defined. This must contain at least one address but no more than 100. EndpointSlices generated by the EndpointSlice controller will always have exactly 1 address. No semantics are defined for additional addresses beyond the first, and kube-proxy does not look at them."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  ...
  '#withAddresses':: d.fn(help='"addresses of this endpoint. For EndpointSlices of addressType \\"IPv4\\" or \\"IPv6\\", the values are IP addresses in canonical form. The syntax and semantics of other addressType values are not defined. This must contain at least one address but no more than 100. EndpointSlices generated by the EndpointSlice controller will always have exactly 1 address. No semantics are defined for additional addresses beyond the first, and kube-proxy does not look at them."', args=[d.arg(name='addresses', type=d.T.array)]),
  withAddresses(addresses): { addresses: if std.isArray(v=addresses) then addresses else [addresses] },
  '#withAddressesMixin':: d.fn(help='"addresses of this endpoint. For EndpointSlices of addressType \\"IPv4\\" or \\"IPv6\\", the values are IP addresses in canonical form. The syntax and semantics of other addressType values are not defined. This must contain at least one address but no more than 100. EndpointSlices generated by the EndpointSlice controller will always have exactly 1 address. No semantics are defined for additional addresses beyond the first, and kube-proxy does not look at them."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='addresses', type=d.T.array)]),
