{
  ...
  '#mapConditions':: d.fn(help="\"Represents the latest available observations of a deployment's current state.\"\n\n**Note:** This function maps each element using the provided function", args=[d.arg(name='f', type=d.T['function'])]),
  mapConditions(f): { conditions: std.map(f, super.conditions) },
  '#withAvailableReplicas':: d.fn(help='"Total number of available non-terminating pods (ready for at least minReadySeconds) targeted by this deployment."', args=[d.arg(name='availableReplicas', type=d.T.integer)]),
  ...
  '#withReadyReplicas':: d.fn(help='"Total number of non-terminating pods targeted by this Deployment with a Ready Condition."', args=[d.arg(name='readyReplicas', type=d.T.integer)]),
  withReadyReplicas(readyReplicas): { readyReplicas: readyReplicas },
  '#withReplicas':: d.fn(help='"Total number of non-terminating pods targeted by this deployment (their labels match the selector)."', args=[d.arg(name='replicas', type=d.T.integer)]),
  withReplicas(replicas): { replicas: replicas },
  '#withTerminatingReplicas':: d.fn(help='"Total number of terminating pods targeted by this deployment. Terminating pods have a non-null .metadata.deletionTimestamp and have not yet reached the Failed or Succeeded .status.phase.\\n\\nThis is a beta field and requires enabling DeploymentReplicaSetTerminatingReplicas feature (enabled by default)."', args=[d.arg(name='terminatingReplicas', type=d.T.integer)]),
  ...
  '#withUpdatedReplicas':: d.fn(help='"Total number of non-terminating pods targeted by this deployment that have the desired template spec."', args=[d.arg(name='updatedReplicas', type=d.T.integer)]),
