{
  ...
  '#mapResources':: d.fn(help='"resources contains the name of the resources and if they are namespaced."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapResources(f): { resources: std.map(f, super.resources) },
  '#mapResourcesByName':: d.fn(help='"resources contains the name of the resources and if they are namespaced."\n\n**Note:** This function maps the element matching name using the provided function', args=[d.arg(name='name', type=d.T.string), d.arg(name='transformFunc', type=d.T['function'])]),
  mapResourcesByName(name, transformFunc): { resources: [if c.name == name then transformFunc(c) else c for c in super.resources] },
