{
  ...
  '#mapCategories':: d.fn(help="\"categories is a list of the grouped resources this resource belongs to (e.g. 'all')\"\n\n**Note:** This function maps each element using the provided function", args=[d.arg(name='f', type=d.T['function'])]),
  mapCategories(f): { categories: std.map(f, super.categories) },
  '#mapShortNames':: d.fn(help='"shortNames is a list of suggested short names of the resource."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapShortNames(f): { shortNames: std.map(f, super.shortNames) },
  '#mapVerbs':: d.fn(help='"verbs is a list of supported kube verbs (this includes get, list, watch, create, update, patch, delete, deletecollection, and proxy)"\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
