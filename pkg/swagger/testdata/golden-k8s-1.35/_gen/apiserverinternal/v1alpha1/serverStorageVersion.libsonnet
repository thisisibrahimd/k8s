{
  ...
  '#mapDecodableVersions':: d.fn(help='"The API server can decode objects encoded in these versions. The encodingVersion must be included in the decodableVersions."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapDecodableVersions(f): { decodableVersions: std.map(f, super.decodableVersions) },
  '#mapServedVersions':: d.fn(help='"The API server can serve these versions. DecodableVersions must include all ServedVersions."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapServedVersions(f): { servedVersions: std.map(f, super.servedVersions) },
