{
  ...
  spec: {
    ...
    cephfs: {
      ...
      mapMonitors(f): { spec+: { cephfs+: { monitors: std.map(f, super.monitors) } } },
    ...
    csi: {
      ...
      nodeExpandSecretRef: {
        '#withName':: d.fn(help='"name is unique within a namespace to reference a secret resource."', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { spec+: { csi+: { nodeExpandSecretRef+: { name: name } } } },
        '#withNamespace':: d.fn(help='"namespace defines the space within which the secret name must be unique."', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { spec+: { csi+: { nodeExpandSecretRef+: { namespace: namespace } } } },
      },
    ...
    fc: {
      ...
      mapTargetWWNs(f): { spec+: { fc+: { targetWWNs: std.map(f, super.targetWWNs) } } },
      ...
      mapWwids(f): { spec+: { fc+: { wwids: std.map(f, super.wwids) } } },
    ...
    iscsi: {
      ...
      mapPortals(f): { spec+: { iscsi+: { portals: std.map(f, super.portals) } } },
      '#secretRef':: d.obj(help='"SecretReference represents a Secret Reference. It has enough information to retrieve secret in any namespace"'),
      secretRef: {
        '#withName':: d.fn(help='"name is unique within a namespace to reference a secret resource."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    mapAccessModes(f): { spec+: { accessModes: std.map(f, super.accessModes) } },
    ...
    mapMountOptions(f): { spec+: { mountOptions: std.map(f, super.mountOptions) } },
    ...
    nodeAffinity: {
      ...
      required: {
        ...
        mapNodeSelectorTerms(f): { spec+: { nodeAffinity+: { required+: { nodeSelectorTerms: std.map(f, super.nodeSelectorTerms) } } } },
    ...
    rbd: {
      ...
      mapMonitors(f): { spec+: { rbd+: { monitors: std.map(f, super.monitors) } } },
      '#secretRef':: d.obj(help='"SecretReference represents a Secret Reference. It has enough information to retrieve secret in any namespace"'),
      secretRef: {
        '#withName':: d.fn(help='"name is unique within a namespace to reference a secret resource."', args=[d.arg(name='name', type=d.T.string)]),
