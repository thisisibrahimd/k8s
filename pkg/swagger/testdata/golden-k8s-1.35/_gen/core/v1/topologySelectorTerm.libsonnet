{
  ...
  '#mapMatchLabelExpressions':: d.fn(help='"A list of topology selector requirements by labels."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapMatchLabelExpressions(f): { matchLabelExpressions: std.map(f, super.matchLabelExpressions) },
