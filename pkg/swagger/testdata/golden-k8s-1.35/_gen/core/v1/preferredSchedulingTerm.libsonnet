{
  ...
  preference: {
    '#mapMatchExpressions':: d.fn(help="\"A list of node selector requirements by node's labels.\"\n\n**Note:** This function maps each element using the provided function", args=[d.arg(name='f', type=d.T['function'])]),
    mapMatchExpressions(f): { preference+: { matchExpressions: std.map(f, super.matchExpressions) } },
    '#mapMatchFields':: d.fn(help="\"A list of node selector requirements by node's fields.\"\n\n**Note:** This function maps each element using the provided function", args=[d.arg(name='f', type=d.T['function'])]),
    mapMatchFields(f): { preference+: { matchFields: std.map(f, super.matchFields) } },
