{
  ...
  postStart: {
    ...
    exec: {
      ...
      mapCommand(f): { postStart+: { exec+: { command: std.map(f, super.command) } } },
    ...
    httpGet: {
      ...
      mapHttpHeaders(f): { postStart+: { httpGet+: { httpHeaders: std.map(f, super.httpHeaders) } } },
      ...
      mapHttpHeadersByName(name, transformFunc): { postStart+: { httpGet+: { httpHeaders: [if c.name == name then transformFunc(c) else c for c in super.httpHeaders] } } },
    ...
    sleep: {
      ...
      withSeconds(seconds): { postStart+: { sleep+: { seconds: seconds } } },
    },
  ...
  preStop: {
    ...
    exec: {
      '#mapCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"\n\n**Note:** This function maps each element using the provided function", args=[d.arg(name='f', type=d.T['function'])]),
      mapCommand(f): { preStop+: { exec+: { command: std.map(f, super.command) } } },
      '#withCommand':: d.fn(help="\"Command is the command line to execute inside the container, the working directory for the command  is root ('/') in the container's filesystem. The command is simply exec'd, it is not run inside a shell, so traditional shell instructions ('|', etc) won't work. To use a shell, you need to explicitly call out to that shell. Exit status of 0 is treated as live/healthy and non-zero is unhealthy.\"", args=[d.arg(name='command', type=d.T.array)]),
    ...
    httpGet: {
      '#mapHttpHeaders':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
      mapHttpHeaders(f): { preStop+: { httpGet+: { httpHeaders: std.map(f, super.httpHeaders) } } },
      '#mapHttpHeadersByName':: d.fn(help='"Custom headers to set in the request. HTTP allows repeated headers."\n\n**Note:** This function maps the element matching name using the provided function', args=[d.arg(name='name', type=d.T.string), d.arg(name='transformFunc', type=d.T['function'])]),
      mapHttpHeadersByName(name, transformFunc): { preStop+: { httpGet+: { httpHeaders: [if c.name == name then transformFunc(c) else c for c in super.httpHeaders] } } },
      '#withHost':: d.fn(help='"Host name to connect to, defaults to the pod IP. You probably want to set \\"Host\\" in httpHeaders instead."', args=[d.arg(name='host', type=d.T.string)]),
    ...
    sleep: {
      '#withSeconds':: d.fn(help='"Seconds is the number of seconds to sleep."', args=[d.arg(name='seconds', type=d.T.integer)]),
      withSeconds(seconds): { preStop+: { sleep+: { seconds: seconds } } },
    },
    '#tcpSocket':: d.obj(help='"TCPSocketAction describes an action based on opening a socket"'),
    tcpSocket: {
      '#withHost':: d.fn(help='"Optional: Host name to connect to, defaults to the pod IP."', args=[d.arg(name='host', type=d.T.string)]),
