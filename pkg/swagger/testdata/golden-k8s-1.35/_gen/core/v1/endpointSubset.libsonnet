{
  ...
  '#mapAddresses':: d.fn(help='"IP addresses which offer the related ports that are marked as ready. These endpoints should be considered safe for load balancers and clients to utilize."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapAddresses(f): { addresses: std.map(f, super.addresses) },
  '#mapNotReadyAddresses':: d.fn(help='"IP addresses which offer the related ports but are not currently marked as ready because they have not yet finished starting, have recently failed a readiness check, or have recently failed a liveness check."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapNotReadyAddresses(f): { notReadyAddresses: std.map(f, super.notReadyAddresses) },
  '#mapPorts':: d.fn(help='"Port numbers available on the related IP addresses."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapPorts(f): { ports: std.map(f, super.ports) },
  '#mapPortsByName':: d.fn(help='"Port numbers available on the related IP addresses."\n\n**Note:** This function maps the element matching name using the provided function', args=[d.arg(name='name', type=d.T.string), d.arg(name='transformFunc', type=d.T['function'])]),
