{
  ...
  linux: {
    '#mapSupplementalGroups':: d.fn(help='"SupplementalGroups are the supplemental groups initially attached to the first process in the container"\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
    mapSupplementalGroups(f): { linux+: { supplementalGroups: std.map(f, super.supplementalGroups) } },
