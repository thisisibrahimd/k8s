{
  ...
  cephfs: {
    ...
    mapMonitors(f): { cephfs+: { monitors: std.map(f, super.monitors) } },
  ...
  downwardAPI: {
    ...
    mapItems(f): { downwardAPI+: { items: std.map(f, super.items) } },
  ...
  ephemeral: {
    ...
    volumeClaimTemplate: {
      ...
      metadata: {
        ...
        mapFinalizers(f): { ephemeral+: { volumeClaimTemplate+: { metadata+: { finalizers: std.map(f, super.finalizers) } } } },
        ...
        mapManagedFields(f): { ephemeral+: { volumeClaimTemplate+: { metadata+: { managedFields: std.map(f, super.managedFields) } } } },
        ...
        mapOwnerReferences(f): { ephemeral+: { volumeClaimTemplate+: { metadata+: { ownerReferences: std.map(f, super.ownerReferences) } } } },
        ...
        mapOwnerReferencesByName(name, transformFunc): { ephemeral+: { volumeClaimTemplate+: { metadata+: { ownerReferences: [if c.name == name then transformFunc(c) else c for c in super.ownerReferences] } } } },
      ...
      spec: {
        ...
        '#mapAccessModes':: d.fn(help='"accessModes contains the desired access modes the volume should have. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#access-modes-1"\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
        mapAccessModes(f): { ephemeral+: { volumeClaimTemplate+: { spec+: { accessModes: std.map(f, super.accessModes) } } } },
        ...
        selector: {
          '#mapMatchExpressions':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
          mapMatchExpressions(f): { ephemeral+: { volumeClaimTemplate+: { spec+: { selector+: { matchExpressions: std.map(f, super.matchExpressions) } } } } },
  ...
  fc: {
    ...
    mapTargetWWNs(f): { fc+: { targetWWNs: std.map(f, super.targetWWNs) } },
    ...
    mapWwids(f): { fc+: { wwids: std.map(f, super.wwids) } },
  ...
  '#image':: d.obj(help='"ImageVolumeSource represents a image volume resource."'),
  image: {
  ...
  iscsi: {
    ...
    mapPortals(f): { iscsi+: { portals: std.map(f, super.portals) } },
    '#secretRef':: d.obj(help='"LocalObjectReference contains enough information to let you locate the referenced object inside the same namespace."'),
    secretRef: {
      '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
  ...
  projected: {
    ...
    mapSources(f): { projected+: { sources: std.map(f, super.sources) } },
  ...
  rbd: {
    ...
    mapMonitors(f): { rbd+: { monitors: std.map(f, super.monitors) } },
    '#secretRef':: d.obj(help='"LocalObjectReference contains enough information to let you locate the referenced object inside the same namespace."'),
    secretRef: {
      '#withName':: d.fn(help='"Name of the referent. This field is effectively required, but due to backwards compatibility is allowed to be empty. Instances of this type with an empty value here are almost certainly wrong. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names/#names"', args=[d.arg(name='name', type=d.T.string)]),
  ...
  secret: {
    ...
    mapItems(f): { secret+: { items: std.map(f, super.items) } },
    '#withDefaultMode':: d.fn(help='"defaultMode is Optional: mode bits used to set permissions on created files by default. Must be an octal value between 0000 and 0777 or a decimal value between 0 and 511. YAML accepts both octal and decimal values, JSON requires decimal values for mode bits. Defaults to 0644. Directories within the path are not affected by this setting. This might be in conflict with other options that affect the file mode, like fsGroup, and the result can be other mode bits set."', args=[d.arg(name='defaultMode', type=d.T.integer)]),
