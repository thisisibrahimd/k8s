{
  ...
  mapAccessModes(f): { accessModes: std.map(f, super.accessModes) },
  ...
  mapMountOptions(f): { mountOptions: std.map(f, super.mountOptions) },
  ...
  nodeAffinity: {
    ...
    required: {
      ...
      mapNodeSelectorTerms(f): { nodeAffinity+: { required+: { nodeSelectorTerms: std.map(f, super.nodeSelectorTerms) } } },
