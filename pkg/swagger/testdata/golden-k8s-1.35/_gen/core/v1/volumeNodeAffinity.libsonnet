{
  ...
  required: {
    '#mapNodeSelectorTerms':: d.fn(help='"Required. A list of node selector terms. The terms are ORed."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
    mapNodeSelectorTerms(f): { required+: { nodeSelectorTerms: std.map(f, super.nodeSelectorTerms) } },
