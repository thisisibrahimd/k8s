{
  ...
  appArmorProfile: {
    ...
    withLocalhostProfile(localhostProfile): { appArmorProfile+: { localhostProfile: localhostProfile } },
    ...
    withType(type): { appArmorProfile+: { type: type } },
  },
  ...
  capabilities: {
    ...
    mapAdd(f): { capabilities+: { add: std.map(f, super.add) } },
    '#mapDrop':: d.fn(help='"Removed capabilities"\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
    mapDrop(f): { capabilities+: { drop: std.map(f, super.drop) } },
