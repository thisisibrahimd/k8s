{
  ...
  '#mapAllocatedResourcesStatus':: d.fn(help='"AllocatedResourcesStatus represents the status of various resources allocated for this Pod."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapAllocatedResourcesStatus(f): { allocatedResourcesStatus: std.map(f, super.allocatedResourcesStatus) },
  '#mapAllocatedResourcesStatusByName':: d.fn(help='"AllocatedResourcesStatus represents the status of various resources allocated for this Pod."\n\n**Note:** This function maps the element matching name using the provided function', args=[d.arg(name='name', type=d.T.string), d.arg(name='transformFunc', type=d.T['function'])]),
  mapAllocatedResourcesStatusByName(name, transformFunc): { allocatedResourcesStatus: [if c.name == name then transformFunc(c) else c for c in super.allocatedResourcesStatus] },
  '#mapVolumeMounts':: d.fn(help='"Status of volume mounts."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapVolumeMounts(f): { volumeMounts: std.map(f, super.volumeMounts) },
  '#mapVolumeMountsByName':: d.fn(help='"Status of volume mounts."\n\n**Note:** This function maps the element matching name using the provided function', args=[d.arg(name='name', type=d.T.string), d.arg(name='transformFunc', type=d.T['function'])]),
  ...
  '#user':: d.obj(help='"ContainerUser represents user identity information"'),
  user: {
    ...
    linux: {
      ...
      mapSupplementalGroups(f): { user+: { linux+: { supplementalGroups: std.map(f, super.supplementalGroups) } } },
      ...
      withGid(gid): { user+: { linux+: { gid: gid } } },
      ...
      withSupplementalGroups(supplementalGroups): { user+: { linux+: { supplementalGroups: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } },
      ...
      withSupplementalGroupsMixin(supplementalGroups): { user+: { linux+: { supplementalGroups+: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } },
      ...
      withUid(uid): { user+: { linux+: { uid: uid } } },
    },
  },
  ...
  '#withAllocatedResourcesStatus':: d.fn(help='"AllocatedResourcesStatus represents the status of various resources allocated for this Pod."', args=[d.arg(name='allocatedResourcesStatus', type=d.T.array)]),
  withAllocatedResourcesStatus(allocatedResourcesStatus): { allocatedResourcesStatus: if std.isArray(v=allocatedResourcesStatus) then allocatedResourcesStatus else [allocatedResourcesStatus] },
  '#withAllocatedResourcesStatusMixin':: d.fn(help='"AllocatedResourcesStatus represents the status of various resources allocated for this Pod."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='allocatedResourcesStatus', type=d.T.array)]),
  withAllocatedResourcesStatusMixin(allocatedResourcesStatus): { allocatedResourcesStatus+: if std.isArray(v=allocatedResourcesStatus) then allocatedResourcesStatus else [allocatedResourcesStatus] },
  ...
  '#withStopSignal':: d.fn(help='"StopSignal reports the effective stop signal for this container"', args=[d.arg(name='stopSignal', type=d.T.string)]),
  withStopSignal(stopSignal): { stopSignal: stopSignal },
  '#withVolumeMounts':: d.fn(help='"Status of volume mounts."', args=[d.arg(name='volumeMounts', type=d.T.array)]),
