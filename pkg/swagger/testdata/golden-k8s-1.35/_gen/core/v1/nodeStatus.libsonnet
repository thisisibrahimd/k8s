{
  ...
  '#mapAddresses':: d.fn(help="\"List of addresses reachable to the node. Queried from cloud provider, if available. More info: https://kubernetes.io/docs/reference/node/node-status/#addresses Note: This field is declared as mergeable, but the merge key is not sufficiently unique, which can cause data corruption when it is merged. Callers should instead use a full-replacement patch. See https://pr.k8s.io/79391 for an example. Consumers should assume that addresses can change during the lifetime of a Node. However, there are some exceptions where this may not be possible, such as Pods that inherit a Node's address in its own status or consumers of the downward API (status.hostIP).\"\n\n**Note:** This function maps each element using the provided function", args=[d.arg(name='f', type=d.T['function'])]),
  mapAddresses(f): { addresses: std.map(f, super.addresses) },
  '#mapConditions':: d.fn(help='"Conditions is an array of current observed node conditions. More info: https://kubernetes.io/docs/reference/node/node-status/#condition"\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapConditions(f): { conditions: std.map(f, super.conditions) },
  '#mapDeclaredFeatures':: d.fn(help='"DeclaredFeatures represents the features related to feature gates that are declared by the node."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapDeclaredFeatures(f): { declaredFeatures: std.map(f, super.declaredFeatures) },
  '#mapImages':: d.fn(help='"List of container images on this node"\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapImages(f): { images: std.map(f, super.images) },
  '#mapRuntimeHandlers':: d.fn(help='"The available runtime handlers."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapRuntimeHandlers(f): { runtimeHandlers: std.map(f, super.runtimeHandlers) },
  '#mapRuntimeHandlersByName':: d.fn(help='"The available runtime handlers."\n\n**Note:** This function maps the element matching name using the provided function', args=[d.arg(name='name', type=d.T.string), d.arg(name='transformFunc', type=d.T['function'])]),
  mapRuntimeHandlersByName(name, transformFunc): { runtimeHandlers: [if c.name == name then transformFunc(c) else c for c in super.runtimeHandlers] },
  '#mapVolumesAttached':: d.fn(help='"List of volumes that are attached to the node."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapVolumesAttached(f): { volumesAttached: std.map(f, super.volumesAttached) },
  '#mapVolumesAttachedByName':: d.fn(help='"List of volumes that are attached to the node."\n\n**Note:** This function maps the element matching name using the provided function', args=[d.arg(name='name', type=d.T.string), d.arg(name='transformFunc', type=d.T['function'])]),
  mapVolumesAttachedByName(name, transformFunc): { volumesAttached: [if c.name == name then transformFunc(c) else c for c in super.volumesAttached] },
  '#mapVolumesInUse':: d.fn(help='"List of attachable volumes in use (mounted) by the node."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapVolumesInUse(f): { volumesInUse: std.map(f, super.volumesInUse) },
  '#nodeInfo':: d.obj(help='"NodeSystemInfo is a set of ids/uuids to uniquely identify the node."'),
  nodeInfo: {
    '#swap':: d.obj(help='"NodeSwapStatus represents swap memory information."'),
    swap: {
      '#withCapacity':: d.fn(help='"Total amount of swap memory in bytes."', args=[d.arg(name='capacity', type=d.T.integer)]),
      withCapacity(capacity): { nodeInfo+: { swap+: { capacity: capacity } } },
    },
  ...
  '#withConditions':: d.fn(help='"Conditions is an array of current observed node conditions. More info: https://kubernetes.io/docs/reference/node/node-status/#condition"', args=[d.arg(name='conditions', type=d.T.array)]),
  withConditions(conditions): { conditions: if std.isArray(v=conditions) then conditions else [conditions] },
  '#withConditionsMixin':: d.fn(help='"Conditions is an array of current observed node conditions. More info: https://kubernetes.io/docs/reference/node/node-status/#condition"\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='conditions', type=d.T.array)]),
  withConditionsMixin(conditions): { conditions+: if std.isArray(v=conditions) then conditions else [conditions] },
  '#withDeclaredFeatures':: d.fn(help='"DeclaredFeatures represents the features related to feature gates that are declared by the node."', args=[d.arg(name='declaredFeatures', type=d.T.array)]),
  withDeclaredFeatures(declaredFeatures): { declaredFeatures: if std.isArray(v=declaredFeatures) then declaredFeatures else [declaredFeatures] },
  '#withDeclaredFeaturesMixin':: d.fn(help='"DeclaredFeatures represents the features related to feature gates that are declared by the node."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='declaredFeatures', type=d.T.array)]),
  withDeclaredFeaturesMixin(declaredFeatures): { declaredFeatures+: if std.isArray(v=declaredFeatures) then declaredFeatures else [declaredFeatures] },
