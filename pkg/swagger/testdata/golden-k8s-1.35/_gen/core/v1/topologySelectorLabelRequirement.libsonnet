{
  ...
  '#mapValues':: d.fn(help='"An array of string values. One value must match the label to be selected. Each entry in Values is ORed."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapValues(f): { values: std.map(f, super.values) },
