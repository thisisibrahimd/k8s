{
  ...
  '#mapCommand':: d.fn(help="\"Entrypoint array. Not executed within a shell. The image's ENTRYPOINT is used if this is not provided. Variable references $(VAR_NAME) are expanded using the container's environment. If a variable cannot be resolved, the reference in the input string will be unchanged. Double $$ are reduced to a single $, which allows for escaping the $(VAR_NAME) syntax: i.e. \\\"$$(VAR_NAME)\\\" will produce the string literal \\\"$(VAR_NAME)\\\". Escaped references will never be expanded, regardless of whether the variable exists or not. Cannot be updated. More info: https://kubernetes.io/docs/tasks/inject-data-application/define-command-argument-container/#running-a-command-in-a-shell\"\n\n**Note:** This function maps each element using the provided function", args=[d.arg(name='f', type=d.T['function'])]),
  ...
  '#mapPorts':: d.fn(help='"Ports are not allowed for ephemeral containers."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapPorts(f): { ports: std.map(f, super.ports) },
  '#mapPortsByName':: d.fn(help='"Ports are not allowed for ephemeral containers."\n\n**Note:** This function maps the element matching name using the provided function', args=[d.arg(name='name', type=d.T.string), d.arg(name='transformFunc', type=d.T['function'])]),
  mapPortsByName(name, transformFunc): { ports: [if c.name == name then transformFunc(c) else c for c in super.ports] },
  '#mapResizePolicy':: d.fn(help='"Resources resize policy for the container."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapResizePolicy(f): { resizePolicy: std.map(f, super.resizePolicy) },
  '#mapRestartPolicyRules':: d.fn(help='"Represents a list of rules to be checked to determine if the container should be restarted on exit. You cannot set this field on ephemeral containers."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  ...
  '#mapVolumeMounts':: d.fn(help="\"Pod volumes to mount into the container's filesystem. Subpath mounts are not allowed for ephemeral containers. Cannot be updated.\"\n\n**Note:** This function maps each element using the provided function", args=[d.arg(name='f', type=d.T['function'])]),
  mapVolumeMounts(f): { volumeMounts: std.map(f, super.volumeMounts) },
  '#mapVolumeMountsByName':: d.fn(help="\"Pod volumes to mount into the container's filesystem. Subpath mounts are not allowed for ephemeral containers. Cannot be updated.\"\n\n**Note:** This function maps the element matching name using the provided function", args=[d.arg(name='name', type=d.T.string), d.arg(name='transformFunc', type=d.T['function'])]),
  ...
  '#withRestartPolicy':: d.fn(help='"Restart policy for the container to manage the restart behavior of each container within a pod. You cannot set this field on ephemeral containers."', args=[d.arg(name='restartPolicy', type=d.T.string)]),
  withRestartPolicy(restartPolicy): { restartPolicy: restartPolicy },
  '#withRestartPolicyRules':: d.fn(help='"Represents a list of rules to be checked to determine if the container should be restarted on exit. You cannot set this field on ephemeral containers."', args=[d.arg(name='restartPolicyRules', type=d.T.array)]),
  ...
  '#withRestartPolicyRulesMixin':: d.fn(help='"Represents a list of rules to be checked to determine if the container should be restarted on exit. You cannot set this field on ephemeral containers."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='restartPolicyRules', type=d.T.array)]),
