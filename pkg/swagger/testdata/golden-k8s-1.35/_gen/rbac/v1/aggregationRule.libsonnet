{
  ...
  '#mapClusterRoleSelectors':: d.fn(help="\"ClusterRoleSelectors holds a list of selectors which will be used to find ClusterRoles and create the rules. If any of the selectors match, then the ClusterRole's permissions will be added\"\n\n**Note:** This function maps each element using the provided function", args=[d.arg(name='f', type=d.T['function'])]),
  mapClusterRoleSelectors(f): { clusterRoleSelectors: std.map(f, super.clusterRoleSelectors) },
