{
  ...
  '#mapConditions':: d.fn(help='"conditions is the set of conditions required for this autoscaler to scale its target, and indicates whether or not those conditions are met."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapConditions(f): { conditions: std.map(f, super.conditions) },
  '#mapCurrentMetrics':: d.fn(help='"currentMetrics is the last read state of the metrics used by this autoscaler."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
  mapCurrentMetrics(f): { currentMetrics: std.map(f, super.currentMetrics) },
