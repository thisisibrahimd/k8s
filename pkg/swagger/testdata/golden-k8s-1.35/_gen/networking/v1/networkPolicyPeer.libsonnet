{
  ...
  '#ipBlock':: d.obj(help="\"IPBlock describes a particular CIDR (Ex. \\\"192.168.1.0/24\\\",\\\"2001:db8::/64\\\") that is allowed to the pods matched by a NetworkPolicySpec's podSelector. The except entry describes CIDRs that should not be included within this rule.\""),
  ipBlock: {
    ...
    mapExcept(f): { ipBlock+: { except: std.map(f, super.except) } },
  ...
  podSelector: {
    '#mapMatchExpressions':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
    mapMatchExpressions(f): { podSelector+: { matchExpressions: std.map(f, super.matchExpressions) } },
    '#withMatchExpressions':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."', args=[d.arg(name='matchExpressions', type=d.T.array)]),
