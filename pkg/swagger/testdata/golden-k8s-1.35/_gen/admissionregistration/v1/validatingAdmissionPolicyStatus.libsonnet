{
  ...
  '#':: d.pkg(name='validatingAdmissionPolicyStatus', url='', help='"ValidatingAdmissionPolicyStatus represents the status of an admission validation policy."'),
  '#mapConditions':: d.fn(help="\"The conditions represent the latest available observations of a policy's current state.\"\n\n**Note:** This function maps each element using the provided function", args=[d.arg(name='f', type=d.T['function'])]),
  ...
  typeChecking: {
    ...
    mapExpressionWarnings(f): { typeChecking+: { expressionWarnings: std.map(f, super.expressionWarnings) } },
