{
  ...
  matchResources: {
    '#mapExcludeResourceRules':: d.fn(help='"ExcludeResourceRules describes what operations on what resources/subresources the policy should not care about. The exclude rules take precedence over include rules (if a resource matches both, it is excluded)"\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
    mapExcludeResourceRules(f): { matchResources+: { excludeResourceRules: std.map(f, super.excludeResourceRules) } },
    '#mapResourceRules':: d.fn(help='"ResourceRules describes what operations on what resources/subresources the admission policy matches. The policy cares about an operation if it matches _any_ Rule."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
    mapResourceRules(f): { matchResources+: { resourceRules: std.map(f, super.resourceRules) } },
    ...
    namespaceSelector: {
      ...
      mapMatchExpressions(f): { matchResources+: { namespaceSelector+: { matchExpressions: std.map(f, super.matchExpressions) } } },
    ...
    objectSelector: {
      '#mapMatchExpressions':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
      mapMatchExpressions(f): { matchResources+: { objectSelector+: { matchExpressions: std.map(f, super.matchExpressions) } } },
      '#withMatchExpressions':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."', args=[d.arg(name='matchExpressions', type=d.T.array)]),
  ...
  paramRef: {
    ...
    selector: {
      '#mapMatchExpressions':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."\n\n**Note:** This function maps each element using the provided function', args=[d.arg(name='f', type=d.T['function'])]),
      mapMatchExpressions(f): { paramRef+: { selector+: { matchExpressions: std.map(f, super.matchExpressions) } } },
      '#withMatchExpressions':: d.fn(help='"matchExpressions is a list of label selector requirements. The requirements are ANDed."', args=[d.arg(name='matchExpressions', type=d.T.array)]),
